<?php
    ...
    /**
     *  Bu Trait Anonym.php framework'de view ve veritabanında debug olaylarının yapılabilmesi için tasarlanmıştır
...
trait Debug {
    ...
    {
        $this->debugInstance = Singleton::make('Anonym\Debug\DebugListener');
    }
