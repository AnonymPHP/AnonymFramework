<?php
    ...
    /**
     *  Bu Sınıf AnonymFramework' e ait bir sınıftır, istenilirse kopyalanılıp ayrı olarak kullanılabilir.
    ...
    use Anonym\Mail\Content\ManagerInterface;
    use PHPMailer;
