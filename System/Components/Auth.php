<?php
    ...
    /**
     * Bu sınıf AnonymFramework'e ait bir sınıftır.AnonymFrameworkde kullanıcı login işlemini tutar.
     *
    ...
    use Anonym\Facade\Cookie;
    use Anonym\Helpers\Config;
    use Anonym\Http\UserManager;
    use InvalidArgumentException;
    use Anonym\Facade\Session;
