<?php
    ...
    /**
     * AnonymFramework Captcha oluşturma sınıfı
     *
     * @package  Anonym;
    ...
    class Captcha
    {
        ...
        public function generate()
        {
            ...
            imagestring($resim, rand(4, 9), rand($this->getWidth() / rand(20, 40), $this->getWidth() / rand(5, 10)),
               rand($this->getHeight() / 4, 22), $yeniresimmetni, $fontrenk);
