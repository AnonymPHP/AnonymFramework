<?php
    ...
    use Anonym\Facade\Event as EventDispatcher;
    ...
    {
        return (new \Anonym\View())->setFileName($file)->setParams($parametres);
    }
    ...
    {
        return (new \Anonym\Twig())->setFileName($file)->setParams($parametres);
    }
    ...
    {
        $path = new \Anonym\Assets\VersionPackpage('', '%v%f');
